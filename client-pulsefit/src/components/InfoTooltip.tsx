...
const GLOSSARY = {
   kcal: {
      ...
      body: 'kcal y "calorías" son lo mismo — son las unidades con las que medimos cuánta energía te da la comida. Tu objetivo diario es la cantidad que necesitás para llegar a tu meta de peso. Si es bajar, las kcal serán menores que las que gastás; si es ganar, más.'
   },
   macros: {
      title: '¿Qué son los macros?',
      body: 'Son los 3 nutrientes que aportan energía: proteína (construye y mantiene músculo), carbos (energía rápida) y grasas (saciedad y hormonas). Acá te los damos en gramos por día. No tenés que contarlos a mano — el plan ya viene cuadrado.'
   },
   protein: {
      title: 'Proteína',
   ...
   carbs: {
      title: 'Carbohidratos',
      body: 'Energía principal del cuerpo. Vienen de arroz, papa, plátano, avena, pan. No son malos — sin carbos no rendís bien. El plan ya tiene la cantidad ideal para tu objetivo.'
   },
   fats: {
      title: 'Grasas',
      body: 'Saciedad + hormonas + absorber vitaminas. Vienen de aguacate, aceite de oliva, frutos secos, pescados grasos. Necesitás un mínimo todos los días — no son enemigas.'
   },
   rpe: {
      title: '¿Qué es RPE?',
      body: 'RPE es "Rate of Perceived Exertion" — qué tan duro sentís el ejercicio del 1 al 10. RPE 7 = podrías haber hecho 3 reps más. RPE 8 = 2 más. RPE 9 = 1 más. RPE 10 = imposible una más. Te pedimos esfuerzo medio (7) para crecer sin quemarte.'
   },
   deload: {
      title: '¿Qué es semana de descarga?',
      body: 'Cada 4-6 semanas bajamos un poco la intensidad para que el cuerpo absorba lo entrenado. No es una semana de descanso total — entrenás igual pero con menos peso/reps. Mejora resultados a largo plazo.'
   },
   tmb: {
      title: '¿Qué es TMB?',
